...
print(f'Total cells: {total_cells}, total lines: {total_lines}')
img.save('test_debug2.png', quality=95)
print('Saved test_debug2.png')
import os
print('Size:', os.path.getsize('test_debug2.png'))
